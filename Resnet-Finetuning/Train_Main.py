...
tf.app.flags.DEFINE_string('training_file', '../ColumbTrainTest/trainColumb1.txt', 'Training dataset file')
tf.app.flags.DEFINE_string('val_file','../ColumbTrainTest/testColumb1.txt', 'Validation dataset file')
